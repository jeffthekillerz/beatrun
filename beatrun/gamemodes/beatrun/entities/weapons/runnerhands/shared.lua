...
function SWEP:Reload()
    ...
    if not TUTORIALMODE and CurTime() > self.RespawnDelay and self.Owner:GetClimbing() == 0 and not IsValid(self.Owner:GetSwingbar()) and not self.Owner.BuildMode then
        self.Owner:Spawn()
