...
local deletionraretbl = {"...", "Kc7bUS7z", "817"}

local deletioncredits = {"Beatrun", "   ", "   ", "Programming", "| datae", "   ", "   ", "Various assets & concepts", "| Mirror's Edge (EA)", "| Tetris Effect (Resonair)", "| Dying Light (Techland)", "   ", "   ", "Credits music", "| \"Sunrise\" from OneShot", "   ", "   ", "Special thanks to", "", "   ", "   ", "   ", "   ", "   ", "Get the fuck out of the credits this part of the mod isnt finished"}
